...
####################################################################################################
# About module file
_MODULE_FILE_NAME = "setGround.mod"
_MODULE_NAME = "setGround"
_MODULE_VERSION = "1.0.0"
_SCRIPTS_DIR_NAME = "src"

# About shelf button
_COMMAND = """import maya_set_ground_ui as scr<COMMAND_NEW_LINE>reload(scr)<COMMAND_NEW_LINE>scr.execute()<COMMAND_NEW_LINE>"""
